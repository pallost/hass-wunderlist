...
UPDATED_EVENT = 'todo_list_updated'
...
async def websocket_list_tasks(hass, connection, msg):
    ...
    Async friendly.
    """
    entity_id = msg.get(ATTR_ENTITY_ID)
    todolist = get_todolist_instance(hass, connection, entity_id)
...
async def websocket_create_task(hass, connection, msg):
    ...
    hass.bus.async_fire(UPDATED_EVENT, entity_id)
